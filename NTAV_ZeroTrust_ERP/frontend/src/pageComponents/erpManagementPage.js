...
class ERPManagementPage extends Component {
  ...
  render() {
    ...
    return (
      <div className="erpManagementPage">
        <WholeHeaderBar handleLogoClick={this.handleLogoClick} />

        <div className="erpManagementContent"> 
          <ProfileCard/>
...
export default withRouter(ERPManagementPage);  // withRouter로 감싸기