...
class ItSecurityPage extends Component {
  ...
  render() {
    ...
    return (
      <div className="itSecurityPage">
        <WholeHeaderBar handleLogoClick={this.handleLogoClick} />

        <div className="itSecurityContent"> 
          <ProfileCard/>
...
export default withRouter(ItSecurityPage);  // withRouter로 감싸기