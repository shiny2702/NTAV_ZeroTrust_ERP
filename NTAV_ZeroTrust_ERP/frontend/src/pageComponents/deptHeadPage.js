...
class DeptHeadPage extends Component {
  ...
  render() {
    ...
    return (
      <div className="deptHeadPage">
        <WholeHeaderBar handleLogoClick={this.handleLogoClick} />

        <div className="deptHeadContent"> 
          <ProfileCard/>
...
export default withRouter(DeptHeadPage);  // withRouter로 감싸기